    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationDestination(isPresented: $showResults) {
                //MealAnalysisViewPrototype(items: analyzedItems, image: capturedImage, onLogMeal: nil)
        ...
        VStack(spacing: 16) {
            if cameraAvailable {
                Button {
                    ...
                    Label("Camera (USDA API)", systemImage: "camera.fill")
                        .font(.headline)
                ...
                /*Button {
                    ...
                    Label("Camera (ML Model)", systemImage: "camera.fill")
                        .font(.headline)
                        .frame(maxWidth: .infinity)
                        .padding(.vertical, 16)
                        .background(Color(red: 0.2, green: 0.55, blue: 0.35))
