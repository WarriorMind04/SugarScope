...
final class WatchConnectivityManager: NSObject, WCSessionDelegate {
    ...
    // Usamos @Published manualmente con objectWillChange
    ...
    func session(_ session: WCSession,
        ...
        print("📱➡️⌚️ Watch received message: \(message)")
        
        // Manejar diferentes tipos de mensajes
        if message["type"] as? String == "sugarAlert" {
            handleSugarAlert(message)
    ...
    private func handleSugarAlert(_ message: [String: Any]) {
        ...
        DispatchQueue.main.async {
            print("🔥 Playing haptic and showing alert")
